...
\addcontentsline{toc}{section}{7.1. Conclusions}
    ...
    Thanks to the nature of this project that required maintenance during use with real patients, we were also able to experience the experience of deploying the application on a real server, a completely unexplored terrain during the university career. \newline
